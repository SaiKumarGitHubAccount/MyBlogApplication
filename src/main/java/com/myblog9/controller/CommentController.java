...
import com.myblog9.service.impl.CommentService;
...
public class CommentController {
    ...
    //POSTMAN---->POST:http://localhost:7000/api/comments?postId=1
    @PostMapping
    ...
    //POSTMAN---->Delete:http://localhost:7000/api/comments?postId=1&commentId=1
    @DeleteMapping
    public ResponseEntity<String> deleteById(@RequestParam long postId, @RequestParam long commentId) {
    ...
    //POSTMAN---->POST:http://localhost:7000/api/comments?commentId=1
    @PutMapping
